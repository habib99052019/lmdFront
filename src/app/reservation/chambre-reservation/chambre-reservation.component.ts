      ...
      const dialogRef = this.dialog.open(DialogreservationnInfosComponent, {
       ...
       // panelClass: 'custom-dialog-container',
        ...
        data:{
          ...
          DOUBLE_BAS_SAISON: clickInfo.event.extendedProps.roomID.DOUBLE_BAS_SAISON_PRICE,
          DOUBLE_HAUTE_SAISON: clickInfo.event.extendedProps.roomID.DOUBLE_HAUTE_SAISON_PRICE,
          SINGLE_BAS_SAISON: clickInfo.event.extendedProps.roomID.SINGLE_BAS_SAISON_PRICE,
          SINGLE_HAUTE_SAISON: clickInfo.event.extendedProps.roomID.SINGLE_HAUTE_SAISON_PRICE,
